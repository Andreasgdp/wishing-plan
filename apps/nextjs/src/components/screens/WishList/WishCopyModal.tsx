...
export type DestinationId = WishListId | PlanId;

type WishCopyModalProps = {
  buttonName: string;
...
export const WishCopyModal = (props: WishCopyModalProps) => {
  ...
  return (
    <>
      {props.menuProps ? (
        <MenuItem {...props.menuProps} onClick={openModal}>
          {props.buttonName}
        </MenuItem>
      ) : (
